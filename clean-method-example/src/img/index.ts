...
export const dogHeaders = BASE_URL_CLOUDINARY + 'v1642273958/dogHeader_gkzduy.png';
export const bgBack = BASE_URL_CLOUDINARY + 'v1642273906/bgBack_zujybg.png';
export const bgFront = BASE_URL_CLOUDINARY + 'v1642273926/bgFront_og7tql.png';
export const footer = BASE_URL_CLOUDINARY + 'v1642273959/footer_egpz0j.png';
